...
//   const prompt = `判断主题列表中的每一项是否是给定文本中的的一个话题
//   以列表的形式给出答案，每个主题用0或1表示
//   主题列表：${topicList.join(',')}
//   给定文本：${story_q}
//   `
...
// `
// const prompt = `你的任务时从电子商务网站上生成一个产品评论的简要摘要：
// 最多30个词汇
// 聚焦在产品价格和质量上
// 产品评论：
// ${prod_review_zh}
...
// `
// const review = [review_2, review_3, review_4]
//  const prompt = `你的任务时从电子商务网站上的产品评论中提取出产品价格和质量相关的信息：
// 文本${review}
// `
