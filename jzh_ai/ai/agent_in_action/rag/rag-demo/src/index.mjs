...
console.log('\n [检测到的文档及相似度评分]');
docs.forEach((doc,i) => {
  const scoredResult = scoredResults.find(([scoresDoc]) =>
    scoresDoc.pageContent === doc.pageContent
  )
  //retriever 过滤 ，rerank 
  //1- 表示值越大越相似 cosine 相似度
